...
"""
# La classe Voto non ha metodi ma tiene insieme una serie di attributi
# correlati. Uso il decoratore @dataclass
@dataclass
class Voto:
    esame: str
    cfu: int
...
# La classe Libretto non ha attributi ma solo metodi. Non ha senso usare qui
